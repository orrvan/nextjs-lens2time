  ...
  <link rel="manifest" href="/manifest.json" /> */}
    ...
    <div className={styles.moreList}>
      ...
      <div className={styles.atlas}>
        ...
        <span style={clickMoreListFlag[0] ?{color:'rgba(0,0,0,1)',fontSize:'12px',fontFamily:'PingFangSC-regular'}:{color:'rgba(52,52,52,1)',fontSize:'12px',fontFamily:'PingFangSC-regular'}}>Atlas</span>
      </div>
