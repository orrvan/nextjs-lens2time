    ...
    <div className={styles.header}>
      ...
      <div className={styles.h_menu}>
        ...
        <div className={styles.div_Mine}>
          <div onClick={switchBodyACollection}  className={headerProps.bodyACollectionFlag ? styles.btn_Collection : styles.btn_NotSelected_color}>Mine</div>
        </div>
        <div className={styles.div_Create}>
          <div onClick={switchBodyAExhibition}  className={headerProps.bodyAExhibitionFlag ? styles.btn_Exhibition : styles.btn_NotSelected_color}>Create</div>
        </div>
      </div>
...
  return (
  <div className={styles.container}>
    <Header headerProps={{bodyACollectionFlag,bodyAExhibitionFlag,setbodyACollectionFlag,setbodyAExhibitionFlag,addCollectionComponentFlag,setaddCollectionComponentFlag,setaddCollectionComponentMovieFlag,setaddCollectionComponentMusicFlag,setbodyBCollectionBlankFlag,myProfile,setMyProfile,setMyBrochures,setMyBrochuresMusic,setMyBrochuresMovie,createUser,searchUser,setLoadingFlag}}></Header>
