...
export default function Home({data}) {
  ...
  <link rel="manifest" href="/manifest.json" /> */}
    ...
    {!clickMoreFlag && <div className={styles.moreUnClick} onClick={switchMore}><span>More</span></div>}
    <div className={styles.moreList}>
      {clickMoreFlag && <div className={styles.more} onClick={switchMore}><span>More</span></div>}
