...
  return (
  <div className={styles.container}>
    ...
    {
      addCollectionComponentMusicFlag == true && <AddCollectionComponentMusic addCollectionComponentMusicProps={{addCollectionComponentMusicFlag,setaddCollectionComponentMusicFlag,myProfile,setMyProfile,setbodyBCollectionBlankFlag,myBrochuresMusic,setMyBrochuresMusic,createUser,searchUser,save,setLoadingFlag,addOrEditCollectionComponentMusicFlag,brochureSelectedMusic}} ></AddCollectionComponent>
    }
    {
      addCollectionComponentMovieFlag == true && <AddCollectionComponentMovie addCollectionComponentMovieProps={{addCollectionComponentMovieFlag,setaddCollectionComponentMovieFlag,myProfile,setMyProfile,setbodyBCollectionBlankFlag,myBrochuresMovie,setMyBrochuresMovie,createUser,searchUser,save,setLoadingFlag,addOrEditCollectionComponentMovieFlag,brochureSelectedMovie}} ></AddCollectionComponent>
    }
    {
