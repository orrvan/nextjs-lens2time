...
export default function Brochure({data,id}) {
  ...
  function startOrPlay(obj){
    if(startOrPause){
      console.log(obj)
      setCurrentMusic(obj)
      setStartOrPasue(false)
    }else{
      audioRef.current.pause();
      setStartOrPasue(true)
    }
  ...
  return(
    <div className={styles.cotainer}>
        ...
        <div className={styles.musicStage}>
          {
            brochure &&  brochure.brochure.map((brochurePictureItem,brochurePictureIndex)=>{
              return <div key={brochurePictureIndex}   className={styles.musicContanier}>
                ...
                <div  className={startOrPause?styles.startPlay :styles.pausePlay} onClick={(e)=>{
      ...
      <div className={styles.audioPlayer}>
        ...
        <audio ref={audioRef} onLoadStart={handleLoading} onCanPlayThrough={handleCanPlay} src={currentMusic.src} controls></audio>
      </div>
    </div>
  ) 
}
