        ...
        <div className={styles.body1Contanier}>
          <div className={styles.body1Info}>
            ...
            <div className={styles.brochureInfo}>
              ...
              <div className={styles.authorProfile} style={{width:'100%',height:'1.786rem',}}><div><span>{myProfile.name}</span><div className={styles.goToMyProfile}></div></div><img style={{width:'1.7rem',height:'1.7rem',overflow:'hidden',borderRadius:'0.85rem',border:'1px solid #f1f1f1'}} src={myProfile.avatarUrl} alt={'当前网络不可用'} /></div>
