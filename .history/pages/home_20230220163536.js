...
function AddCollectionComponentMusic({addCollectionComponentMusicProps}){
  ...
  const dataCreateBrochure =React.useRef({
    ...
    brochure:[],
    likes:addCollectionComponentMusicProps.brochureSelectedMusicMusic.current.likes,
    content:addCollectionComponentMusicProps.brochureSelectedMusicMusic.current.content,
    slots:addCollectionComponentMusicProps.brochureSelectedMusicMusic.current.slots,
    bgImg:addCollectionComponentMusicProps.brochureSelectedMusicMusic.current.bgImg,
    views:addCollectionComponentMusicProps.brochureSelectedMusicMusic.current.views,
    id:addCollectionComponentMusicProps.brochureSelectedMusicMusic.current.id
  })
  ...
  useEffect(() =>{
    ...
    fetchCollections(0)
    //第一步首先装填收藏品并生成所含所有图片的数组，并保存至dataRefCollections.current.pictures
  },[addCollectionComponentMusicProps.addCollectionComponentFlag])
  /********************************装填出版物，获取个人在LENS服务器上的帖子，并生成数组****************************************/
  //这里的index用来表示，是重置出版物，还是获取下一个出版物，index 值为0或者1,0表示重置，重新装填一遍。1表示获取下次出版物并装填
  async function fetchPublications(index){
