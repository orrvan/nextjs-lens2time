...
export default function Home({data}) {
  ...
  const [clickMoreFlag,setClickMoreFlag] = useState(false)
  ...
  <link rel="manifest" href="/manifest.json" /> */}
    ...
    {
      clickMoreFlag && <div className={styles.moreList} className={styles.atlas} style={!clickMoreFlag && {animation:'slide-out 0.5s ease-in-out forwards'}}>
