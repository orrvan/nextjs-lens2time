  ...
  <div className={styles.container}>
    <div className={styles.header}>
      ...
      <div className={styles.options}>
        ...
        {<div className={clickIndexFlag[0] ? styles.interestsActive : styles.interests}  style={{}}>Interests</div>}        
        {<div className={clickIndexFlag[0] ? styles.createActive : styles.create}  style={{}}>Create
