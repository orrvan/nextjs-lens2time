...
export default function Home({data}) {
  ...
  <link rel="manifest" href="/manifest.json" /> */}
    ...
    <div className={styles.moreList}>
      ...
      <span style={clickMoreListFlag[0] ?{color:'rgba(0,0,0,1)',fontSize:'12px',fontFamily:' PingFangSC-semiBold'}:{color:'rgba(52,52,52,1)',fontSize:'12px',fontFamily:'PingFangSC-regular'}}>Album</span>
      </div>
      <div className={styles.playlist}>
      <span style={clickMoreListFlag[0] ?{color:'rgba(0,0,0,1)',fontSize:'12px',fontFamily:' PingFangSC-semiBold'}:{color:'rgba(52,52,52,1)',fontSize:'12px',fontFamily:'PingFangSC-regular'}}>PlayList</span>
      </div>
      <div className={styles.show}>
      <span style={clickMoreListFlag[0] ?{color:'rgba(0,0,0,1)',fontSize:'12px',fontFamily:' PingFangSC-semiBold'}:{color:'rgba(52,52,52,1)',fontSize:'12px',fontFamily:'PingFangSC-regular'}}>Show</span>
      </div>
    </div>
