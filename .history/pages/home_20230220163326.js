...
function AddCollectionComponentMusic({addCollectionComponentProps}){
  /*****************************用来绘制背包图片1的数组*************************/
  const [knapsackPictures,setKnapsackPictures] =React.useState([])
   /*****************************用来绘制背包图片2的数组*************************/
  const [knapsackPictures2,setKnapsackPictures2] =React.useState([])
  ...
  const noImage="data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http%3A//www.w3.org/2000/svg' viewBox='0 0 700 475'%3E%3Cfilter id='b' color-interpolation-filters='sRGB'%3E%3CfeGaussianBlur stdDeviation='20'/%3E%3C/filter%3E%3Cimage preserveAspectRatio='none' filter='url(%23b)' x='0' y='0' height='100%25' width='100%25' href='data:image/svg+xml;base64,'/%3E%3C/svg%3E"
  const [brochure,setBrochure] =React.useState(addCollectionComponentProps.brochureSelectedMusic.current.brochure)
  /*****歌单 */
  // const [brochureMusic,setBrochureMusic] =React.useState(addCollectionComponentProps.brochureSelectedMusic.current.brochure)
  // const [brochure,setBrochure] =React.useState([])
  /****************用来控制用户到底能不能继续装载POST或者Collections，如果用户总帖子少于12条，那么无需再装载，如何用户装计载计数器大于5次，图片还是小于12张，也无需再加载************************ */
  ...
  /*********用来收集创建册子的表单数据 ******************************/
  const dataCreateBrochure =React.useRef({
    brochureName:addCollectionComponentProps.brochureSelectedMusic.current.brochureName,
    brochureTag:addCollectionComponentProps.brochureSelectedMusic.current.brochureTag,
    brochure:[],
    likes:addCollectionComponentProps.brochureSelectedMusicMusic.current.likes,
    content:addCollectionComponentProps.brochureSelectedMusicMusic.current.content,
    slots:addCollectionComponentProps.brochureSelectedMusicMusic.current.slots,
    bgImg:addCollectionComponentProps.brochureSelectedMusicMusic.current.bgImg,
    views:addCollectionComponentProps.brochureSelectedMusicMusic.current.views,
    id:addCollectionComponentProps.brochureSelectedMusicMusic.current.id
  })
  ...
  function cancelCreatBrochure(e){
    e.stopPropagation() //阻止冒泡事件
    console.log('cancelCreatBrochure')
    addCollectionComponentProps.setaddCollectionComponentMusicFlag(false)
    setKnapsackPictures([])
  }
  useEffect(() =>{
    console.log('你已经打开了背包界面')
  ...
  async function submitCreate(){
    ...
    if(dataCreateBrochure.current.brochure.length>0){
      ...
      if(searchData.data.length>0){
        ...
        addCollectionComponentProps.setaddCollectionComponentMusicFlag(false)
        addCollectionComponentProps.setbodyBCollectionBlankFlag(false)
        addCollectionComponentProps.setMyBrochuresMusic(data.brochures)
        addCollectionComponentProps.setLoadingFlag(false)
        // setKnapsackPictures([])
        // setKnapsackPictures2([])
        // dataRef.current = {cursor:[null,null],pictures:[]}
  ...
  async function submitUpdate(){
    addCollectionComponentProps.setLoadingFlag(true)
    let index = addCollectionComponentProps.brochureSelectedMusic.current.index
    dataCreateBrochure.current.brochure = [].concat(brochure)
    // console.log(dataCreateBrochure)
    const regexStr =/^[\u4e00-\u9fa5_a-zA-Z0-9]+$/
    if(dataCreateBrochure.current.brochureName && regexStr.test(dataCreateBrochure.current.brochureName)){
  ...
  return(
    <div onClick={cancelPrompt} className={styles.addCollectionContainer}>
      <div className={styles.addCollectionView}>
        ...
        {addCollectionComponentProps.addOrEditCollectionComponentMusicFlag ? <button onClick={submitCreate}  className={styles.part4_createBtn }>Create</button> :  <button onClick={submitUpdate}  className={styles.part4_createBtn }>update</button>  }
...
function AddCollectionComponentMovie({addCollectionComponentProps}){
  /*****************************用来绘制背包图片1的数组*************************/
  const [knapsackPictures,setKnapsackPictures] =React.useState([])
   /*****************************用来绘制背包图片2的数组*************************/
  const [knapsackPictures2,setKnapsackPictures2] =React.useState([])
  ...
  const noImage="data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http%3A//www.w3.org/2000/svg' viewBox='0 0 700 475'%3E%3Cfilter id='b' color-interpolation-filters='sRGB'%3E%3CfeGaussianBlur stdDeviation='20'/%3E%3C/filter%3E%3Cimage preserveAspectRatio='none' filter='url(%23b)' x='0' y='0' height='100%25' width='100%25' href='data:image/svg+xml;base64,'/%3E%3C/svg%3E"
  const [brochure,setBrochure] =React.useState(addCollectionComponentProps.brochureSelectedMovie.current.brochure)
  /*****歌单 */
  // const [brochureMusic,setBrochureMusic] =React.useState(addCollectionComponentProps.brochureSelectedMusic.current.brochure)
  // const [brochure,setBrochure] =React.useState([])
  /****************用来控制用户到底能不能继续装载POST或者Collections，如果用户总帖子少于12条，那么无需再装载，如何用户装计载计数器大于5次，图片还是小于12张，也无需再加载************************ */
  ...
  /*********用来收集创建册子的表单数据 ******************************/
  const dataCreateBrochure =React.useRef({
    brochureName:addCollectionComponentProps.brochureSelectedMovie.current.brochureName,
    brochureTag:addCollectionComponentProps.brochureSelectedMovie.current.brochureTag,
    brochure:[],
    likes:addCollectionComponentProps.brochureSelectedMovie.current.likes,
    content:addCollectionComponentProps.brochureSelectedMovie.current.content,
    slots:addCollectionComponentProps.brochureSelectedMovie.current.slots,
    bgImg:addCollectionComponentProps.brochureSelectedMovie.current.bgImg,
    views:addCollectionComponentProps.brochureSelectedMovie.current.views,
    id:addCollectionComponentProps.brochureSelectedMovie.current.id
  })
  ...
  function cancelCreatBrochure(e){
    e.stopPropagation() //阻止冒泡事件
    console.log('cancelCreatBrochure')
    addCollectionComponentProps.setaddCollectionComponentMovieFlag(false)
    setKnapsackPictures([])
  }
  useEffect(() =>{
    console.log('你已经打开了背包界面')
  ...
  async function submitCreate(){
    ...
    if(dataCreateBrochure.current.brochure.length>0){
      ...
      if(searchData.data.length>0){
        ...
        addCollectionComponentProps.setaddCollectionComponentMovieFlag(false)
        addCollectionComponentProps.setbodyBCollectionBlankFlag(false)
        addCollectionComponentProps.setMyBrochuresMovie(data.brochures)
        addCollectionComponentProps.setLoadingFlag(false)
        // setKnapsackPictures([])
        // setKnapsackPictures2([])
        // dataRef.current = {cursor:[null,null],pictures:[]}
  ...
  async function submitUpdate(){
    addCollectionComponentProps.setLoadingFlag(true)
    let index = addCollectionComponentProps.brochureSelectedMovie.current.index
    dataCreateBrochure.current.brochure = [].concat(brochure)
    // console.log(dataCreateBrochure)
    const regexStr =/^[\u4e00-\u9fa5_a-zA-Z0-9]+$/
    if(dataCreateBrochure.current.brochureName && regexStr.test(dataCreateBrochure.current.brochureName)){
  ...
  return(
    <div onClick={cancelPrompt} className={styles.addCollectionContainer}>
      <div className={styles.addCollectionView}>
        ...
        {addCollectionComponentProps.addOrEditCollectionComponentMovieFlag ? <button onClick={submitCreate}  className={styles.part4_createBtn }>Create</button> :  <button onClick={submitUpdate}  className={styles.part4_createBtn }>update</button>  }
        </div>
      </div>
      <div className={styles.addCollectionKnapsack}>
        <div className={styles.knapsack_part1}>
...
  return (
  <div className={styles.container}>
    <Header headerProps={{bodyACollectionFlag,bodyAExhibitionFlag,setbodyACollectionFlag,setbodyAExhibitionFlag,addCollectionComponentFlag,setaddCollectionComponentFlag,setaddCollectionComponentMovieFlag,setAddOrEditCollectionComponentMusicFlag,setbodyBCollectionBlankFlag,myProfile,setMyProfile,setMyBrochures,createUser,searchUser,setLoadingFlag}}></Header>
    {bodyACollectionFlag == true && <BodyACollection bodyACollectionProps={{setaddCollectionComponentFlag,setaddCollectionComponentMovieFlag,setaddCollectionComponentMusicFlag, myProfile,setMyProfile,setAddOrEditCollectionComponentFlag,setAddOrEditCollectionComponentMovieFlag,setAddOrEditCollectionComponentMusicFlag,brochureSelected,brochureSelectedMovie,brochureSelectedMusic}}></BodyACollection>
    }
    {
    ...
    {
      bodyACollectionFlag == true && bodyBCollectionBlankFlag == false && !addCollectionComponentFlag && <BodyBCollectionFull bodyBCollectionFullProps={{myBrochures,myBrochuresMusic,myBrochuresMovie,setMyBrochures,setMyBrochuresMovie,setMyBrochuresMusic,myProfile,searchUser,save,setLoadingFlag,setaddCollectionComponentFlag,setaddCollectionComponentMovieFlag,setaddCollectionComponentMusicFlag,setAddOrEditCollectionComponentFlag,setAddOrEditCollectionComponentMovieFlag,setAddOrEditCollectionComponentMusicFlag,brochureSelected,brochureSelectedMovie,brochureSelectedMusic}}></BodyBCollectionFull>
    }
    {
