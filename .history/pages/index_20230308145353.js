  ...
  <div className={styles.container}>
    <div className={styles.header}>
      ...
      <div className={styles.options}>
        ...
        {<div className={clickIndexFlag[0] ? styles.interestsActive : styles.interests}  style={{width:'28.5%' ,color:'rgba(0, 0, 0, 1)',borderRight:'1px solid rgba(187,187,187,0.5)'}}>Interests</div>}        
