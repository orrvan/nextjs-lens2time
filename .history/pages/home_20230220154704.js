...
  return (
  <div className={styles.container}>
    ...
    {
      addCollectionComponentFlag == true && <AddCollectionComponent addCollectionComponentProps={{addCollectionComponentFlag,setaddCollectionComponentFlag,myProfile,setMyProfile,setbodyBCollectionBlankFlag,myBrochures,setMyBrochures,createUser,searchUser,save,setLoadingFlag,addOrEditCollectionComponentFlag,addOrEditCollectionComponentMovieFlag,addOrEditCollectionComponentMusicFlag,brochureSelected,brochureSelectedMovie,brochureSelectedMusic}} ></AddCollectionComponent>
    }
    {
      bodyACollectionFlag == true && bodyBCollectionBlankFlag == false && !addCollectionComponentFlag && <BodyBCollectionFull bodyBCollectionFullProps={{myBrochures,setMyBrochures,myProfile,searchUser,save,setLoadingFlag,setaddCollectionComponentFlag,setAddOrEditCollectionComponentFlag,setAddOrEditCollectionComponentMovieFlag,setAddOrEditCollectionComponentMusicFlag,brochureSelected,brochureSelectedMovie,brochureSelectedMusic}}></BodyBCollectionFull>
    }
    {
