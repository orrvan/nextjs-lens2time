...
export default function Home() {
  ...
  const [bodyACollectionFlag, setbodyAMineFlag] = React.useState(true) 
  const [bodyAExhibitionFlag, setbodyACreateFlag] = React.useState(false) 
...
  return (
  <div className={styles.container}>
    ...
    {
      bodyAExhibitionFlag == true && <BodyAExhibition bodyAExhibitionProps={{setbodyACreateFlag,setaddExhibitionComponentFlag}}></BodyAExhibition>
    }
    {
