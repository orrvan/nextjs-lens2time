...
export default function Brochure({data,id}) {
  ...
  return(
    <div className={styles.cotainer}>
      ...
      }} style={{position:'fixed',width:'96%',height:'96%',left:'2%',top:'2%',background:'#f1f1f1' ,display:'flex',flexFlow:'row nowarp',alignItems:'center',filter:'drop-shadow(2px 4px 6px black)'}}>
