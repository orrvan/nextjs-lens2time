...
export default function Brochure({data,id}) {
  ...
  return(
    <div className={styles.cotainer}>
      ...
      }} style={{position:'fixed',width:'96%',height:'96%',left:'2%',top:'2%',background:'rgba(0,0,0,0.6)' ,display:'flex',flexFlow:'row nowarp',justifyContent:'center',alignItems:'center',filter:'drop-shadow(2px 4px 6px black)'}}>
