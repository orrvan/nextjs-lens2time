...
export default function Brochure({data,id}) {
  ...
  return(
    <div className={styles.cotainer}>
      ...
      }} style={{position:'fixed',width:'96%',height:'96%',left:'2%',top:'2%',background:'#000' ,textAlign:'center',filter:'drop-shadow(2px 4px 6px black)'}}>
                        <video controls style={{width:'100%',height:'100%'}} src={videoLargeSiz}></video>  
                      </div>}
    </div>
  ) 
}
