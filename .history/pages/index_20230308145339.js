  ...
  <div className={styles.container}>
    <div className={styles.header}>
      ...
      <div className={styles.options}>
        {<div className={clickIndexFlag[0] ? styles.recommendationActive : styles.recommendation} style={{width:"48.25%",color:'rgba(0, 0, 0, 1)',borderRight:'1px solid rgba(187,187,187,0.5)'}}>Recommendation</div>} 
        {<div className={clickIndexFlag[0] ? styles.recommendationActive : styles.recommendation}  style={{width:'28.5%' ,color:'rgba(0, 0, 0, 1)',borderRight:'1px solid rgba(187,187,187,0.5)'}}>Interests</div>}        
        {<div className={clickIndexFlag[0] ? styles.createActive : styles.create}  style={{width:'23.25%',color:'rgba(0, 0, 0, 1)'}}>Create
        ...
        {!clickIndexFlag[2] &&<div style={{width:'23.25%',color:'rgba(190, 190, 190, 1)'}}>Create
        <div className={styles.downArrow1}></div>
        </div>} */}
      </div>
      <div></div>
